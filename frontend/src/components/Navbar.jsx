...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-center items-center'>
        ...
        {menu && <div className='z-50 fixed top-[90px] bg-[#1557bf] flex flex-col items-center justify-center px-3 py-1 text-2xl font-[500] rounded-[20px] space-y-2 py-2'>
        <button>Profile</button>
        <button onClick={logout} className='bg-[#0e1d36] px-3 py-2 rounded-full'>Log Out</button>
        </div>}
