...
const Navbar = ({profile}) => {
  ...
  return (
    <div className='flex justify-center items-center'>
        ...
        {menu && <div className='z-50 border-[3.5px] border-blue-600 border-t-blue-300 border-b-blue-300 fixed top-[90px] bg-gray-900 flex flex-col items-center justify-center px-3 text-2xl font-[500] rounded-[20px] space-y-2 pt-2 pb-3'>
